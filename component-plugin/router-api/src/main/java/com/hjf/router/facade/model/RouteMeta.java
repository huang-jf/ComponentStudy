package com.hjf.router.facade.model;
...
public class RouteMeta {
     ...
     * @param paramsType paramsType
     */
    public RouteMeta(Route route, RouteType type, Map<String, Integer> paramsType) {
        this(type, null, route.name(), route.path(), route.group(), paramsType, route.priority(), route.extras());
    }
